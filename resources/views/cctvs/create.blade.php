            ...
            <div class="glass-effect rounded-2xl p-8 border border-cyan-100 relative overflow-hidden">
                ...
                <form action="{{ route('cctv.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                    ...
                    <div class="md:col-span-2" x-data="{ 
                        open: false, 
                        search: '{{ old('building_id') ? \App\Models\Building::find(old('building_id'))->nama_gedung : '' }}', 
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <input type="text" 
                                       ...
                                       placeholder="Ketik nama gedung... (Contoh: Rektorat)" 
                    ...
                    <div class="md:col-span-2 pt-4 border-t border-slate-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="lat" value="{{ old('lat') }}" placeholder="-6.92610000" class="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 focus:ring-2 focus:ring-cyan-200">
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 mb-2">Longitude</label>
                                <input type="text" name="lng" value="{{ old('lng') }}" placeholder="107.77430000" class="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 focus:ring-2 focus:ring-cyan-200">
                            </div>
                        </div>
                        <p class="text-xs text-slate-400 mt-2 italic">Opsional: Isi untuk menampilkan kamera di Map Monitoring.</p>
                    </div>
