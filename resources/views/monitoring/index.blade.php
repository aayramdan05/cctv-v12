                            ...
                            <div class="relative border border-slate-800 bg-black group overflow-hidden cursor-pointer"
                                ...
                                <template x-if="activeSlots[i]">
                                    <div class="w-full h-full relative bg-black">
                                        ...
                                        <!-- Update: Tambah @timeupdate agar jarum timeline halus -->
                                        <video 
                                            :id="'video-playback-' + i"
    ...
    <script>
        function hybridMonitoring() {
            return {
                ...
                // --- NEW: Handle Time Update (Jarum Timeline Halus) ---
                ...
                // --- CORE LOGIC: ASSIGN CAMERA TO SLOT ---
                ...
                handleVideoEnded(index) {
                    ...
                    if (idx !== -1 && idx < this.currentTimelineData.length - 1) {
                        ...
                        console.log("Playing next part: " + nextSeg.human_start);
