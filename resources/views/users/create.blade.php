            ...
            <div class="glass-effect rounded-2xl p-8 border border-cyan-100">
                ...
                <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div id="cctv_access_section" class="bg-slate-50 p-4 rounded-xl border border-slate-200" style="display: none;">
                         <label class="block text-sm font-bold text-slate-700 mb-2">Akses Kamera Spesifik</label>
                         <p class="text-xs text-slate-500 mb-3">Pilih kamera yang boleh dilihat oleh user/aplikasi ini.</p>
