    ...
    <main id="main-content" class="pt-20 p-6 md:p-8">
        ...
        <div id="breadcrumb" class="mb-6">
            <div class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-slate-400">/</span>
                <span class="text-slate-800 font-medium">Tambah Fakultas</span>
            </div>
        </div>

        <div class="mb-8">
            <h2 class="text-3xl font-bold text-slate-800 mb-2">Tambah Fakultas</h2>
            <p class="text-slate-500">Tambahkan data Fakultas atau Unit Kerja baru ke dalam sistem.</p>
        </div>
                ...
                <form action="{{ route('faculties.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" 
                               class="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-200 outline-none transition-all text-slate-700 placeholder-slate-400"
                               placeholder="Contoh: Fakultas Kedokteran, Rektorat, Lab Sentral..." required>
                        @error('name')
